...
| 7 | Lab 05 Roles | [lab-05-solo-to-team-roles](../labs/lab-05-solo-to-team-roles/README.md) | สร้าง agent artifacts ผ่าน CLI/TUI + `role-cards.json` |
| 8 | Lab 06 Claude multi-agent | [lab-06-claude-multi-agent](../labs/lab-06-claude-multi-agent/README.md) | Claude `frontend`+`code-reviewer` → `handoff-fe.json` |
| 9 | Lab 07 OpenCode sequential | [lab-07-opencode-sequential](../labs/lab-07-opencode-sequential/README.md) | OpenCode `backend`→`qa` + `handoff-be.json` |
| 10 | Lab 08 Gate | [lab-08-quality-cost-gate](../labs/lab-08-quality-cost-gate/README.md) | FAIL→PASS + `audit-result.json` (`--agent qa`) |
| 11 | Lab 09 Synthesize | [lab-09-synthesizer](../labs/lab-09-synthesizer/README.md) | Claude `--agent synthesizer` + เปิดแผง |
| 12 | Lab 10 Flux | [lab-10-kanban-collab](../labs/lab-10-kanban-collab/README.md) | บอร์ดสด + เลื่อนการ์ดหลัง named agent ทำงาน + snapshot |
...
- **Named agents ไม่ทับซ้อน:** FE+synthesizer=Claude · BE+QA=OpenCode
- Loop Lab 10: แตกการ์ด → เรียก named agent ตามแมป → อัปเดต JSON → เลื่อนการ์ด → ด่าน → Ship (Lab 11)

Shared: [contracts](../shared/contracts/), [scripts](../shared/scripts/), [agent-starters](../shared/agent-starters/)  
...
Walkthrough CLI/TUI ทั้งคอร์ส: [WALKTHROUGH-E2E.md](WALKTHROUGH-E2E.md)  
แผน identity (implemented): [MULTI-AGENT-IDENTITY-PLAN.md](MULTI-AGENT-IDENTITY-PLAN.md)
