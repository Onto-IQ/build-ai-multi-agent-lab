# Lab 01 — Claude Code native

**เวลาเป้าหมาย:** 75 นาที  
**เครื่องมือ:** Claude Code · GitHub MCP · `gh`  
**Issue:** `[Lab 01] Add Thai empty-state copy for accounts list`

## ได้รับมาจาก Lab ก่อน

SETUP เสร็จ · มี repo จาก template · มี issues จาก `create-course-issues`

## ได้เพิ่มใน Lab นี้

Plan mode · Explore · เปิด PR ด้วย GitHub MCP แล้วเทียบกับ `gh`
...
Command Center · learning-log อย่างเดียวโดยไม่มี PR
