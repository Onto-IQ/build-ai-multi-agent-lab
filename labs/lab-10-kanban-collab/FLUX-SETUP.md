...
Lab 10 loop (go-live): การ์ดหลัก 3 ใบเท่านั้น → มอบหมายชัด → ทำงานจริง → อัปเดต JSON → เลื่อนตามสถานะ → snapshot จากบอร์ดสด  
ห้ามสร้างการ์ดเพื่องานนับ validator หรือเลื่อนการ์ดโดยไม่มีหลักฐานงาน
...
6. สร้างการ์ด**หลัก 3 ใบเท่านั้น** (Frontend / Backend / QA) — ใส่ในคำอธิบาย:
   `Assignee: <role> | Tool: <Claude Code|OpenCode> | Contract: <path>`
   - Frontend: ปรับ UI / ตารางรอบ  
   - Backend: เติม runs.json จากรอบ Lab  
   - QA: รัน gate-quality แล้วเลื่อนตามผล  
7. มอบหมายบทบาท + เครื่องมือให้ชัด — เปิดบอร์ดแล้วต้องบอกได้ว่าใครรับใบไหน  
8. **เลื่อนการ์ดหลังทำงานจริงเท่านั้น** (เช่น Build → Test เมื่อมีผลใน repo)  
